...
public class CustomCalendarView extends LinearLayout {
    ...
    private com.stacktips.view.CalendarListener calendarListener;
    ...
    private List<com.stacktips.view.DayDecorator> decorators = null;
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        calendarBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_calendarBackgroundColor, getResources().getColor(R.color.background_blue));
        calendarTitleBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_titleLayoutBackgroundColor, getResources().getColor(R.color.background_blue));
        ...
        weekLayoutBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_weekLayoutBackgroundColor, getResources().getColor(R.color.background_blue));
        ...
        disabledDayBackgroundColor = typedArray.getColor(R.styleable.CustomCalendarView_disabledDayBackgroundColor, getResources().getColor(R.color.background_blue));
        disabledDayTextColor = typedArray.getColor(R.styleable.CustomCalendarView_disabledDayTextColor, getResources().getColor(R.color.background_blue));
    ...
    private void setDaysInCalendar() {
        ...
        com.mobatia.bskl.fragment.calendar.calendarutils.DayView dayView;
        ViewGroup dayOfMonthContainer;
        for (int i = 1; i < 43; i++) {
            dayOfMonthContainer = (ViewGroup) view.findViewWithTag(DAY_OF_MONTH_CONTAINER + i);
            dayView = (com.mobatia.bskl.fragment.calendar.calendarutils.DayView) view.findViewWithTag(DAY_OF_MONTH_TEXT + i);
            if (dayView == null)
                continue;
        ...
        dayView = (com.mobatia.bskl.fragment.calendar.calendarutils.DayView ) view.findViewWithTag("dayOfMonthText36");
    ...
    private void clearDayOfTheMonthStyle(Date currentDate) {
        if (currentDate != null) {
            ...
            final com.mobatia.bskl.fragment.calendar.calendarutils.DayView dayView = getDayOfMonthText(calendar);
            dayView.setBackgroundColor(calendarBackgroundColor);
            dayView.setTextColor(dayOfWeekTextColor);
            dayView.decorate();
        }
    ...
    private com.mobatia.bskl.fragment.calendar.calendarutils.DayView getDayOfMonthText(Calendar currentCalendar) {
        return (com.mobatia.bskl.fragment.calendar.calendarutils.DayView) getView(DAY_OF_MONTH_TEXT, currentCalendar);
    }
    ...
    public void markDayAsCurrentDay(Calendar calendar) {
        if (calendar != null && CalendarUtils.isToday(calendar)) {
            com.mobatia.bskl.fragment.calendar.calendarutils.DayView dayOfMonth = getDayOfMonthText(calendar);
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        com.mobatia.bskl.fragment.calendar.calendarutils.DayView view = getDayOfMonthText(currentCalendar);
    ...
    public void setCalendarListener(com.stacktips.view.CalendarListener calendarListener) {
    ...
    public List<com.stacktips.view.DayDecorator> getDecorators() {
        return decorators;
    }

    public void setDecorators(List<com.stacktips.view.DayDecorator> decorators) {
