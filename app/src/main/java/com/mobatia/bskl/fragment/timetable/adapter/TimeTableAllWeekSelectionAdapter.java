...
public class TimeTableAllWeekSelectionAdapter extends RecyclerView.Adapter<TimeTableAllWeekSelectionAdapter.MyViewHolder> {
    ...
    public TimeTableAllWeekSelectionAdapter(Context mContext, ArrayList<PeriodModel> mPeriodList, RecyclerView timeTableAllRecycler, ToolTipLayout tipContainer) {
