...
public class LeaveRequestSubmissionActivity extends AppCompatActivity implements URLConstants, JSONConstants, NaisClassNameConstants {
    Button submitBtn;
...
//        }
        enterStratDate.setText("Day absence reported : "+AppUtils.dateConversionY(AppUtils.getCurrentDateToday()));
        enterStratDate.setEnabled(false);
...
*/
    ...
    private void submitLeave(String URL_API) {
        ...
        String[] value = {PreferenceManager.getAccessToken(mContext), studentIdStr, PreferenceManager.getUserId(mContext),
                Date, toDate, enterMessage.getText().toString().trim()};
