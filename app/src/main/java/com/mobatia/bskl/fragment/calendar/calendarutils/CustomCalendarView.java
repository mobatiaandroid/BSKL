...
import com.mobatia.bskl.fragment.calendar.calendarutils.utils.CalendarUtils;
...
public class CustomCalendarView extends LinearLayout {
    ...
    private void initializeCalendar() {
        ...
        btnWeekView.setOnClickListener(new OnClickListener() {
            @Override
        ...
        btnYearView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
